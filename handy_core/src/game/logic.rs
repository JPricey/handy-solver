...
pub fn resolve_top_card<T: EngineGameState>(state: &T) -> Vec<T> {
    GameStateEvaluator::new(|x| x).resolve_top_card(state)
}
...
pub fn attack_card_get_all_outcomes_allow_whif_hits<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
...
pub fn attack_card_get_all_outcomes<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
...
pub fn unblockable_hit_get_all_outcomes<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
...
pub fn attack_card_get_reaction_outcomes<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
...
pub fn damage_card_with_on_hit_row<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
    row: &Row,
...
pub fn move_card_by_up_to_amount<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    moves_remaining: i32,
    move_type: MoveType,
...
pub fn _get_fireball_outcomes<T: EngineGameState>(
    state: &T,
    active_idx: usize,
    target_idx: usize,
) -> Vec<T> {
...
pub fn move_card_to_end<T: EngineGameState>(
    state: &mut T,
    active_idx: usize,
...
pub fn attack_idx_in_all_states_ignore_no_outcomes_for_any_state<T: EngineGameState>(
    states: &Vec<T>,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
...
pub fn get_claws_results<T: EngineGameState>(
    state: &T,
    active_idx: usize,
...
pub fn get_spaced_claws_result<T: EngineGameState>(
    state: &T,
    active_idx: usize,
    active_allegiance: Allegiance,
...
pub fn try_prevent_action_with_reaction<T: EngineGameState>(
    state: &T,
    target_idx: usize,
...
pub fn get_reaction_assist_results<T: EngineGameState>(
    initial_state: &T,
...
pub fn get_standard_reaction_result<T: EngineGameState>(
    state: &T,
    target_idx: usize,
...
pub fn find_blockers_for_hit_outcomes<T: EngineGameState>(
    state: &T,
    active_idx: usize,
    range_cap: usize,
...
pub fn hurt_card_get_all_outcomes<T: EngineGameState>(
    state: &T,
    target_idx: usize,
    hit_type: HitType,
) -> Vec<T> {
