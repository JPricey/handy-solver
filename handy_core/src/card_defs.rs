...
fn side(health: Health, value: FaceValue) -> FaceDef {
    FaceDef {
        health,
...
impl CardDefs {
    ...
    fn register_card(&mut self, card_def: CardDef) {
        ...
        if new_card_id >= CARDS_SIZE {
            panic!("ID {} is too large. Increase the card_defs size", card_def.id)
        }
    ...
    pub fn new() -> CardDefs {
        ...
        {
            let paladin = CharBuilder::new(Class::Paladin, Allegiance::Hero);
            card_defs.register_card(paladin.card(
                1,
                enum_map! {
                    FaceKey::A => side(Health::Full, 1.8)
                        .add_row(row()
                                .hit_any(2)
                                )
                        .add_row(row()
                    ...
                    FaceKey::B => side(Health::Full, 2.2)
                        .add_row(row()
                            .delay_any(1)
                            .hit_any(2)
                        )
                        ...
                        .block_to_rotate()
                        ,
                    FaceKey::C => side(Health::Empty, 0.1)
                        .add_row(row()
                            .hit_any(2)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::D => side(Health::Half, 1.3)
                        .add_row(row()
                            .hit_any(4)
                        )
                        .add_row(row()
            ...
            card_defs.register_card(paladin.card(
                2,
                enum_map! {
                    FaceKey::A => side(Health::Full, 1.7)
                        .add_row(row()
                            .hit_any(2)
                            .rotate()
                        )
                        ...
                        ,
                    FaceKey::B => side(Health::Full, 2.1)
                        .add_row(row()
                            .heal_any()
                            .rotate()
                        )
                        ...
                        .block_to_rotate()
                        ,
                    FaceKey::C => side(Health::Empty, 0.8)
                        .add_row(row()
                            .quicken_any(2)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::D => side(Health::Half, 0.0)
                        .add_row(row()
                            .heal_any()
                            .rotate()
                        )
            ...
            card_defs.register_card(paladin.card(
                3,
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.0)
                        .add_row(row()
                            .quicken_any(2)
                            .rotate()
                        )
                    ...
                    FaceKey::B => side(Health::Full, 2.1)
                        ...
                        ,
                    FaceKey::C => side(Health::Empty, 0.0)
                        .add_row(row()
                            .quicken_any(2)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::D => side(Health::Half, 1.4)
                        .add_row(row()
                            .hit_any(4)
                        )
                        .add_row(row()
            ...
            card_defs.register_card(paladin.card(
                4,
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.05)
                        .add_row(row()
                            .hit_any(4)
                        )
                        .add_row(row()
                        ...
                        .block_to_rotate()
                        ,
                    FaceKey::B => side(Health::Full, 2.0)
                        .add_row(row()
                            .hit_any(2)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::C => side(Health::Half, 1.4)
                        .add_row(row()
                            .hit_any(4)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::D => side(Health::Empty, 0.6)
                        .add_row(row()
                            .hit_any(2)
                        )
                        .add_row(row()
            ...
            card_defs.register_card(paladin.card(
                5,
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.1)
                        .add_row(row()
                            .quicken_any(2)
                            .hit_any(2)
                        )
                        .block_to_rotate()
                        ,
                    FaceKey::B => side(Health::Full, 1.7)
                        .add_row(row()
                            .hit_any(2)
                            .rotate()
                        )
                        ...
                        ,
                    FaceKey::C => side(Health::Half, 1.1)
                        .add_row(row()
                            .delay_any(3)
                            .hit_any(2)
                            .hit_any(2)
                        ...
                        ,
                    FaceKey::D => side(Health::Empty, 0.0)
                        .add_row(row()
                            .hit_any(4)
                        )
                        .add_row(row()
            ...
            card_defs.register_card(ogre.card(
                ...
                enum_map! {
                    ...
                    FaceKey::C => side(Health::Empty, 0.0)
                        ...
                        ,
                    FaceKey::D => side(Health::Half, -1.0)
...

        {
            ...
            card_defs.register_card(huntress.card(
                11,
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.2)
                        .dodge_to_turn()
                        .add_row(row()
                                 .arrow_any()
                                 .rotate()
                    ...
                    FaceKey::B => side(Health::Full, 2.0)
                        ...
                        ,
                    FaceKey::C => side(Health::Half, 1.3)
                        .add_row(row()
                                 .hit_any(1)
                                 .hit_any(1)
                                 .rotate()
...

        {
            ...
            card_defs.register_card(vampire.card(
                15,
                enum_map! {
                    FaceKey::A => side(Health::Full, -1.0)
                        .add_row(row()
                            .hit_enemy(1)
                            .hit_enemy(1)
                            .flip()
                        ...
                        ,
                    FaceKey::B => side(Health::Full, -1.0)
                        .add_row(row()
                            .pull_ally(3)
                            .pull_ally(3)
                        )
                        ...
                        ,
                    FaceKey::C => side(Health::Half, -0.7)
                        .add_row(row()
                            .hit_enemy(1)
                            .hit_enemy(1)
                            .rotate()
                        ...
                        ,
                    FaceKey::D => side(Health::Empty, -0.3)
                        .add_row(row()
                            .push_enemy(3)
                        )
                        .add_row(row()
            ...
            card_defs.register_card(vampire.card(
                ...
                enum_map! {
                    ...
                    FaceKey::B => side(Health::Full, -1.0)
                        ...
                        ,
                    FaceKey::C => side(Health::Empty, -0.3)
                        .add_row(row()
                            .hit_enemy(5)
                        )
                        .add_row(row()
                        ...
                        ,
                    FaceKey::D => side(Health::Half, -0.7)
                        .add_row(row()
                            .pull_ally(5)
                            .flip()
                        )
            ...
            card_defs.register_card(vampire.card(
                18,
                enum_map! {
                    FaceKey::A => side(Health::Full, -7.0)
                        .feature(Features::Weight)
                        .add_row(row()
                        ...
                        .block_perm()
                        ,
                    FaceKey::B => side(Health::Full, -4.5)
                        .feature(Features::Weight)
                        .add_row(row()
                            .add_condition(Condition::ExhaustedAllies(2))
                            .revive_ally()
                    ...
                    FaceKey::C => side(Health::Empty, 0.0)
                        ...
                        ,
                    FaceKey::D => side(Health::Half, -2.0)
                        .feature(Features::Weight)
                        .add_row(row()
                            .add_condition(Condition::ExhaustedAllies(2))
                            .revive_ally()
            ...
            card_defs.register_card(pyro.card(
                ...
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.0)
                        ...
                        ,
                    FaceKey::B => side(Health::Half, 1.0)
                        .add_row(row()
                                 .energy_cost(3)
                                 .ablaze()
                                 .rotate()
            ...
            card_defs.register_card(spider.card(
                ...
                enum_map! {
                    ...
                    FaceKey::C => side(Health::Empty, 0.0)
                        ...
                        ,
                    FaceKey::D => side(Health::Half, -1.5)
                        .feature(Features::Venom)
                        .swarm(row()
                               .pull_ally(4)
                               .push_enemy(3)
            ...
            card_defs.register_card(spider.card(
                ...
                enum_map! {
                    ...
                    FaceKey::B => side(Health::Full, -2.0)
                        ...
                        ,
                    FaceKey::C => side(Health::Empty, -0.2)
                        .feature(Features::Web)
                        .swarm(row()
                               .revive_ally()
                               )
        ...
        {
            let werewolf = CharBuilder::new(Class::Werewolf, Allegiance::Hero);
            card_defs.register_card(werewolf.card(
                ...
                enum_map! {
                    FaceKey::A => side(Health::Full, 2.0)
                        ...
                        ,
                    FaceKey::B => side(Health::Empty, 0.0)
                        .add_row(row()
                                 .inspire_enemy()
                                 .heal_ally()
                        )
                        ...
                        ,
                    FaceKey::C => side(Health::Half, 1.6)
                        .werewolf()
                        .block_to_rotate()
                        .add_row(row()
                                 .claw_enemy(3)
                        ...
                        ,
                    FaceKey::D => side(Health::Half, 1.1)
                        .add_row(row()
                                 .delay_ally(2)
                                 .rotate()
                        )
...

        {
            ...
            card_defs.register_card(demon.card(
                ...
                enum_map! {
                    FaceKey::A => side(Health::Full, -2.0)
                        ...
                        ,
                    FaceKey::B => side(Health::Half, -1.3)
                        .rage(2)
                        .add_row(row()
                                .rage_condition(3)
                                .pull_ally(5)
            ...
            card_defs.register_card(demon.card(
                34,
                enum_map! {
                    FaceKey::A => side(Health::Full, -2.3)
                        .add_row(row()
                                .rage_condition(5)
                                .death()
                        )
                        ...
                        ,
                    FaceKey::B => side(Health::Half, -1.5)
                        .rage(1)
                        .add_row(row()
                                .rage_condition(4)
                                .void()
...

        {
            ...
            card_defs.register_card(beastmaster.card(
                40,
                enum_map! {
                    FaceKey::A => side(Health::Empty, 0.25)
                    ...
                    FaceKey::B => side(Health::Empty, 0.0)
                        ...
                        ,
                    FaceKey::C => side(Health::Empty, 0.5)
                        ...
                        ,
                    FaceKey::D => side(Health::Empty, 0.75)
                        .provide_assist_block_rotate()
                        .add_assist(row()
                                .claw_enemy(4)
                                .rotate()
        ...
        {
            let verdant = CharBuilder::new(Class::Verdancy, Allegiance::Baddie);
            card_defs.register_card(verdant.card(
                ...
                enum_map! {
                    ...
                    FaceKey::B => side(Health::Empty, 0.0)
                        ...
                        ,
                    FaceKey::C => side(Health::Half, -1.2)
                        .feature(Features::Weight)
